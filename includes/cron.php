...
// Cron checks custom plugin tables; table names come from locarc_tables().
...
function locarc_cron_unschedule() {
	...
	if ( $ts ) {
		wp_unschedule_event( $ts, 'locarc_daily_check' );
	}
}
