<?php
// phpcs:ignoreFile -- Third-party FPDF library kept with its upstream API and coding style.
/*******************************************************************************
 * FPDF                                                                         *
 *                                                                              *
 * Version: 1.9                                                                 *
	...
	public function Output( $dest = '', $name = '', $isUTF8 = false ) {
		...
		switch ( strtoupper( $dest ) ) {
			...
			case 'D':
				...
				break;
			case 'F':
				// The WordPress integration writes the string output through WP_Filesystem.

				$this->Error( 'Direct file output is disabled; use string output instead' );
				break;
			case 'S':
				// Return as a string
				return $this->buffer;
